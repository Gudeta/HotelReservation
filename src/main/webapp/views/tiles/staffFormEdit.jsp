		...
		<table>
			...
			<tr>
				...
				<td><select name="staffGender">
						<option value="Male"
							<c:if test="${editEntry.staffGender=='Male'}">selected</c:if>>Male
						</option>
						<option value="Female"
							<c:if test="${editEntry.staffGender=='Female'}">selected</c:if>>Female
						</option>
		...
		<c:forEach var="staff" items="${stafflist}">
			<tbody>
				<tr>
					...
					<td><a
						href="<spring:url value="/staff/edit/${staff.staffId}"/>">Edit</a>
						| <a href="<spring:url value="/staff/delete/${staff.staffId}"/>">Delete</a></td>
